...
INSERT INTO `signature` VALUES (1,19,'PING',4,1,2,'alert','icmp','any','any','->','$HOME','any','itype:8; ',2),(1,21,'Timestamp Request',2,2,2,'alert','icmp','any','any','->','any','any','itype:13; ',2),(1,22,'Information',2,3,2,'alert','icmp','any','any','->','any','any','itype:15; ',2),(1,23,'Address Mask Request',2,4,2,'alert','icmp','any','any','->','any','any','itype:17; ',2),(1,24,'Half-Open Scan',7,4,8,'alert','tcp','any','any','->','$HOME','any','detection_filter:track by_all, count 20, seconds 6; flags:S; ',2),(1,25,'FIN_Scan',9,2,8,'alert','tcp','any','any','->','$HOME','any','flags:F; detection_filter:track by_all, count 20, seconds 6; ',2),(1,26,'XMAS',2,3,8,'alert','tcp','any','any','->','$HOME','any','flags:FPU; ',2),(1,27,'sql script',3,4,7,'alert','tcp','any','any','->','$HOME','any','content:\"script>\"; nocase; ',3),(1,28,'DNS spoofing',3,5,1,'alert','udp','any','$DNS(TU)','<>','any','any','content:\"|81 80 00 01 00 01 00 00 00 00|\"; content:\"|c0 0c 00 01 00 01 00 00 00 3c 00 04|\"; ',3),(1,29,'Sql injection(And)',5,1,7,'alert','tcp','any','any','->','any','$HTTP(TU)','content:\"|27|\"; content:\"and\"; nocase; ',2),(1,31,'Sql injection(union)',5,2,7,'alert','tcp','any','any','->','any','$HTTP(TU)','content:\"union\"; nocase; ',2),(1,32,'Sql injection(order by)',4,3,7,'alert','tcp','any','any','->','any','$HTTP(TU)','content:\"order by\"; ',2),(1,33,'NetBus_Cpturer_Detect',4,3,4,'alert','tcp','any','any','->','$HOME','any','content:\"CaptureScreen\"; ',4),(0,34,'NetBus_GetApps_Detect',4,2,4,'alert','tcp','any','any','->','$HOME','any','content:\"GetApps\"; ',1),(1,35,'NetBus Keylogging Detect',5,1,4,'alert','tcp','any','any','->','$HOME','any','content:\"Listen\"; ',1),(1,37,'SSH Bruth Force',4,4,3,'alert','tcp','any','$SSH(T)','->','any','any','content:\"|53 53 48|\"; detection_filter:track by_src, count 20, seconds 10; ',3),(1,38,'FTP Brute Detect',11,3,3,'alert','tcp','any','$FTP(T)','->','any','any','content:\"530 login incorrect\"; nocase; ',3),(1,39,'Telnet Brute Force',5,2,3,'alert','tcp','any','$Telnet(T)','->','any','any','content:\"Login Failed\"; nocase; detection_filter:track by_src, count 3, seconds 10; ',1),(1,40,'telnet Brute force',5,1,3,'alert','tcp','any','$Telnet(T)','->','any','any','content:\"login incorrect\"; nocase; detection_filter:track by_src, count 3, seconds 10; ',3),(1,41,'Ftp permisson',3,5,3,'alert','tcp','any','$FTP(T)','->','any','any','content:\"503 permission denied\"; nocase; detection_filter:track by_src, count 4, seconds 6; ',1),(0,42,'sql injection(or)',5,5,7,'alert','tcp','any','any','->','any','$HTTP(TU)','content:\"|22|\"; nocase; content:\"or\"; nocase; ',3),(1,43,'NMAP -sF',1,1,8,'alert','tcp','any','any','->','$HOME','any','flagbits:!M; dsize:0; flags:FPU; ack:0; window:2048; detection_filter:track by_dst, count 1, seconds 60; ',2),(1,44,'sql injection (having)',3,6,7,'alert','tcp','any','any','->','any','$HTTP(TU)','content:\"having\"; nocase; ',3);
