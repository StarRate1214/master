...
INSERT INTO `sig_group` VALUES (2,'ICMP'),(3,'Brute_Force'),(4,'NetBus'),(5,'FTP'),(7,'sql_injection'),(8,'SCAN'),(9,'XXE'),(10,'XSS'),(11,'BAC');
INSERT INTO `signature` VALUES (1,21,'Timestamp Request',3,2,2,'alert','icmp','any','any','->','$HOME','any','itype:13; ',2),(1,22,'Information',3,3,2,'alert','icmp','any','any','->','$HOME','any','itype:15; ',2),(1,23,'Address Mask Request',3,4,2,'alert','icmp','any','any','->','$HOME','any','itype:17; ',2),(1,24,'Half-Open Scan',8,4,8,'alert','tcp','any','any','->','$HOME','any','flags:S; detection_filter:track by_src, count 20, seconds 6; ',2),(1,25,'FIN_Scan',10,2,8,'alert','tcp','any','any','->','$HOME','any','flags:F; detection_filter:track by_src, count 20, seconds 6; ',2),(1,26,'XMAS',2,3,8,'alert','tcp','any','any','->','$HOME','any','flags:FPU; ',2),(1,28,'DNS spoofing',5,5,1,'alert','udp','any','any','<>','$HOME','$DNS(TU)','content:\"|81 80 00 01 00 01 00 00 00 00|\"; content:\"|c0 0c 00 01 00 01 00 00 00 3c 00 04|\"; ',3),(1,33,'NetBus_Cpturer_Detect',4,3,4,'alert','tcp','any','any','->','$HOME','any','content:\"CaptureScreen\"; ',4),(1,34,'NetBus_GetApps_Detect',5,2,4,'alert','tcp','any','any','->','$HOME','any','content:\"GetApps\"; ',2),(1,35,'NetBus Keylogging Detect',6,1,4,'alert','tcp','any','any','->','$HOME','any','content:\"Listen\"; ',2),(1,37,'SSH Bruth Force',6,4,3,'alert','tcp','any','any','->','$HOME','$SSH(T)','content:\"|53 53 48|\"; detection_filter:track by_src, count 20, seconds 10; ',3),(1,38,'FTP Brute Detect',13,3,3,'alert','tcp','any','any','->','$HOME','$FTP(T)','content:\"530 login incorrect\"; nocase; ',3),(1,39,'Telnet Brute Force',9,2,3,'alert','tcp','any','any','->','$HOME','$Telnet(T)','content:\"Login Failed\"; detection_filter:track by_src, count 3, seconds 10; ',2),(1,40,'telnet Brute force',7,1,3,'alert','tcp','any','any','->','$HOME','$Telnet(T)','content:\"login incorrect\"; nocase; detection_filter:track by_src, count 3, seconds 10; ',3),(1,41,'Ftp permisson',6,5,3,'alert','tcp','any','any','->','$HOME','$FTP(T)','content:\"503 permission denied\"; nocase; detection_filter:track by_src, count 4, seconds 6; ',2),(1,43,'NMAP -sF',2,1,8,'alert','tcp','any','any','->','$HOME','any','flagbits:!M; dsize:0; flags:FPU; ack:0; window:2048; detection_filter:track by_src, count 1, seconds 60; ',2),(1,46,'XXE injection(]]>)',4,1,9,'alert','tcp','any','any','->','$HOME','$HTTP(TU)','content:\"]]>\"; ',3),(1,49,'XXE injection (/-->)',4,4,9,'alert','tcp','any','any','->','$HOME','$HTTP(TU)','content:\"/-->\"; ',3),(1,50,'XXE injection (-->)',2,5,9,'alert','tcp','any','any','->','$HOME','$HTTP(TU)','content:\"-->\"; ',3),(1,55,'XXE injection (<!--)',1,7,9,'alert','tcp','any','any','->','$HOME','$HTTP(TU)','content:\"<!--\"; ',3),(1,56,'XXE injection (<![CDATA[)',3,8,9,'alert','tcp','any','any','->','$HOME','$HTTP(TU)','content:\"<![CDATA[\"; ',3),(1,57,'XXE Dos',1,9,9,'alert','tcp','any','any','->','$HOME','$HTTP(TU)','content:\"<!ENTITY\"; detection_filter:track by_src, count 5, seconds 1; ',3),(1,58,'XXE injection (<!DOCTYPE)',3,10,9,'alert','tcp','any','any','->','$HOME','$HTTP(TU)','content:\"<!DOCTYPE\"; nocase; ',3),(1,60,'sql(group by)',1,8,7,'alert','tcp','any','any','->','$HOME','$HTTP(TU)','content:\"group by\"; nocase; ',2),(1,61,'sql(union)',3,9,7,'alert','tcp','any','any','->','$HOME','$HTTP(TU)','content:\"select\"; nocase; content:\"from\"; nocase; content:\"union\"; nocase; ',2),(1,62,'sql(\'--)',5,10,7,'alert','tcp','any','any','->','$HOME','$HTTP(TU)','content:\"|27|\"; content:\"--\"; ',3),(1,63,'XSS(script l)',1,2,10,'alert','tcp','any','any','->','$HOME','$HTTP(TU)','content:\"<script\"; nocase; ',2),(1,64,'XSS(script r)',3,6,10,'alert','tcp','any','any','->','$HOME','$HTTP(TU)','content:\"script>\"; nocase; ',2),(1,65,'XSS(iframe l)',1,3,10,'alert','tcp','any','any','->','$HOME','$HTTP(TU)','content:\"<iframe\"; nocase; ',2),(1,66,'XSS(iframe r)',1,4,10,'alert','tcp','any','any','->','$HOME','$HTTP(TU)','content:\"iframe>\"; nocase; ',2),(1,67,'XSS(iframe src)',1,5,10,'alert','tcp','any','any','->','$HOME','$HTTP(TU)','content:\"iframe src\"; nocase; ',2),(1,68,'XSS(object l)',1,7,10,'alert','tcp','any','any','->','$HOME','$HTTP(TU)','content:\"<object\"; nocase; ',2),(1,69,'XSS(object r)',1,8,10,'alert','tcp','any','any','->','$HOME','$HTTP(TU)','content:\"object>\"; nocase; ',2),(1,70,'XSS(width=0)',1,9,10,'alert','tcp','any','any','->','$HOME','$HTTP(TU)','content:\"width=0\"; nocase; ',2),(1,71,'XSS(height=0)',1,10,10,'alert','tcp','any','any','->','$HOME','$HTTP(TU)','content:\"height=0\"; nocase; ',2),(1,72,'XSS(div style)',1,11,10,'alert','tcp','any','any','->','$HOME','$HTTP(TU)','content:\"div\"; nocase; content:\"style\"; nocase; ',2),(1,73,'BAC(admin)',4,1,11,'alert','tcp','any','any','->','$HOME','$HTTP(TU)','content:\"/admin\"; http_uri; nocase; ',3),(1,74,'BAC(master)',2,2,11,'alert','tcp','any','any','->','$HOME','$HTTP(TU)','content:\"/master\"; http_uri; nocase; ',3),(1,75,'BAC(ssi)',1,3,11,'alert','tcp','any','any','->','$HOME','$HTTP(TU)','content:\"<!--#\"; ',3),(1,76,'BAC(web admin attack)',4,4,11,'alert','tcp','any','any','->','$HOME','$HTTP(TU)','content:\"user_id=admin\"; nocase; detection_filter:track by_src, count 3, seconds 3; ',2),(1,77,'sql(version)',1,11,7,'alert','tcp','any','any','->','$HOME','$HTTP(TU)','content:\"@@version\"; nocase; ',3),(1,78,'BAC(Directory listing)',1,5,11,'alert','tcp','any','any','->','$HOME','$HTTP(TU)','content:\"index of /\"; nocase; ',3),(1,79,'sql(\"--)',1,12,7,'alert','tcp','any','any','->','$HOME','$HTTP(TU)','content:\"|22|\"; content:\"--\"; ',3),(1,80,'SQL Injection UNION SELECT',1,13,7,'alert','tcp','any','any','->','$HOME','$HTTP(TU)','content:\"UNION\"; http_uri; nocase; content:\"SELECT\"; http_uri; nocase; pcre:\"/UNION.+SELECT/Ui\"; ',3),(1,81,'SQL Injection USER in uri',2,14,7,'alert','tcp','any','any','->','$HOME','$HTTP(TU)','content:\"SELECT\"; http_uri; nocase; content:\"USER\"; http_uri; nocase; pcre:\"/SELECT[^a-z].+USER/Ui\"; ',3),(1,82,'SQL Injection INFORMATION  SCHEMA',1,15,7,'alert','tcp','any','any','->','$HOME','$HTTP(TU)','content:\"information_schema\"; http_uri; nocase; ',2),(1,83,'SQL Injection SLEEP',1,16,7,'alert','tcp','any','any','->','any','$HTTP(TU)','content:\"SELECT\"; http_uri; nocase; content:\"SLEEP|28|\"; http_uri; nocase; pcre:\"\\/bSELECT.*?\\bSLEEP\\x28/Ui\"; ',3),(1,84,'SQL Injection SELECT FROM',1,17,7,'alert','tcp','any','any','->','$HOME','$HTTP(TU)','content:\"SELECT\"; http_uri; nocase; content:\"FROM\"; http_uri; nocase; pcre:\"/SELECT\\b.*FROM/Ui\"; ',2),(1,85,'Broken Auth Attack',1,6,3,'alert','tcp','any','any','->','any','$HTTP(TU)','content:\"message_ok\"; detection_filter:track by_src, count 5, seconds 5; content:\"|EC 95 84 EC 9D B4 EB 94 94|\"; ',4),(1,86,'Server Send PHP Error Message',1,6,1,'alert','tcp','any','any','->','$HOME','$HTTP(TU)','content:\"error\"; http_client_body; content:\"php\"; distance:0; nocase; content:\"line\"; distance:0; ',3);
#Event Table
CREATE TABLE event  ( 
